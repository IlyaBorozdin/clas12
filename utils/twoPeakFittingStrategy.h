...
public:
    ...
    double getDeltaPeak(TH1F* hist, int i, int j, int k, int l) const override {
        return DELTA_PEAK_POSITIONS[j];
    }

private:
    static constexpr double MM_UP_EDGES[22] = {
        0.99, 1.04, 1.06, 1.09, 1.09, 1.21, 1.25, 1.30, 1.34,
        1.38, 1.38, 1.38, 1.38, 1.38, 1.38, 1.38, 1.38, 1.38, 1.38, 1.38, 1.38, 1.38
    };

    static constexpr double DELTA_PEAK_POSITIONS[22] = {
        1.000, 1.000, 1.000, 1.000, 1.000, 1.088, 1.134, 1.169, 1.201, 
        1.223, 1.239, 1.230, 1.227, 1.233, 1.216, 1.220, 1.220, 1.220, 1.220, 1.220, 1.220, 1.220
    };
    ...
    bool isEmptyBack(int i, int j, int k, int l) const {
        ...
        if (j >= 15 && j <= 22 && k == 2 && (l >= 5 && l <= 6)) return true;
        return false;
    }
    ...
    void getZerosParabola(int i, int j, int k, int l, double& x1, double& x2) const {
        ...
        if (j == 6 && k >= 3 && k <= 4 && (l <= 3 || l >= 8)) { x1 = 0.80; x2 = 1.20; }
                 ...
                 j >= 15 && j <= 22 && k >= 3 && k <= 5 && (l >= 4 && l <= 7) ||
                 j >= 15 && j <= 17 && k == 6 && (l >= 5 && l <= 6) ||
                 j >= 15 && j <= 22 && k == 10 ||
                 
                 j >= 18 && j <= 22 && k == 2 && (l >= 3 && l <= 4 || l == 7)) { x1 = 0.83; x2 = 1.37; }
                 ...
                 j >= 15 && j <= 22 && k >= 3 && k <= 5 && (l <= 3 || l >= 8) ||
                 j >= 15 && j <= 17 && k == 6 && (l <= 4 || l >= 7) ||
                 j >= 15 && j <= 17 && k >= 7 && k <= 9 ||
                 
                 j >= 18 && j <= 22 && k == 2 && (l <= 2 || l >= 8) ||
                 j >= 18 && j <= 22 && k == 6) { x1 = 0.70; x2 = 0.70; }
    }
};
