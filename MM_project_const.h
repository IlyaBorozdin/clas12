...
/**
 * Необходимо будет отказаться от фиксированного числа бинов по MM
*/
...
/**
 * Слишко много, будет определяться программно
*/
...
/**
 * Убрать из этого файла, здесь только константы для настроек
*/
